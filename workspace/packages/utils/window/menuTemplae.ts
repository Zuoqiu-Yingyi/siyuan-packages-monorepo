 ...
 * 创建 Electron 菜单模板
 * @param top - 是否置顶
 * @param isMacOS - 是否为 macOS 系统
 * @see 
 * {@link https://www.electronjs.org/zh/docs/latest/api/menu-item | 菜单项 - Electron} |
 * {@link https://www.electronjs.org/zh/docs/latest/api/menu#示例 | Menu - Electron}
 */
export function buildMenuTemplate(
    top: boolean = true,
    // eslint-disable-next-line node/prefer-global/process
    isMacOS: boolean = globalThis.process?.platform === "darwin",
): Array<(Electron.MenuItem) | (Electron.MenuItemConstructorOptions)> {
